    ...
    >
      {MOODS.map((mood) => (
        <button
          ...
          className="inline-flex min-h-11 items-center gap-2 rounded-full border border-line bg-card py-1 pl-1.5 pr-4 text-base font-semibold text-ink shadow-sm transition-[color,border-color,transform,box-shadow] motion-safe:hover:-translate-y-0.5 hover:border-brand hover:text-brand-strong hover:shadow-md"
        >
          <span
